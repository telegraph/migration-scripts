...
SOURCE_PACKAGE_USERNAME="telegraph-cq-admin"
SOURCE_PACKAGE_PASSWORD="VO9?~A2BC*VtqG"
SOURCE_PACKAGES_HOST="34.246.40.45"
SOURCE_PACKAGES_PORT="4502"
DELETE_MODE="false"
TEMP_FILE="tmp-author.txt"
LOG_FILE="upload-author-info.log"
