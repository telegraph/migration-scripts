...
# -------- CONFIG --------
OUTPUT_TMP="./../output/a3-migrated"
PACKAGE_NAME="a3-migrated-non-supported-part2-08-03-2022"
PROTOCOL="http://"
USERNAME="<USERNAME>"
PASSWORD="<PASSWORD>"
HOST="<HOST>"
...
SOURCE_PACKAGE_USERNAME="<SOURCE_USERNAME>"
SOURCE_PACKAGE_PASSWORD="<SOURCE_PASSWORD>"
SOURCE_PACKAGES_HOST="<SOURCE_HOST>"
