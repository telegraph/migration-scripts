...
TEMP_FILE="tmp-travelProductListing.txt"
LOG_FILE="info-travelProductListing.log"
# -------- CONFIG --------
...
processTmp () {
	...
	if [ "${DELETE_MODE}" = "true" ]; then
        ...
        cp "${OUTPUT_FILE}/tmp-travelProductListing.txt" "${OUTPUT_FILE}/${packageName}.txt"
        
        filters=$(getFilters "${OUTPUT_FILE}/tmp-travelProductListing.txt" "${packageName}")
